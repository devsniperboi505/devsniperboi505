...
config.fontName = "font/maker.ttf" -- Filename of the font to be used. Leave it blank to use the default font.
...
config.keys.scrollUp = "i" -- Key used to scroll up within the console's message stack.
config.keys.scrollDown = "k" -- Key used to scroll down within the console's message stack.
